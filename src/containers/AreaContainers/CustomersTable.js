...
const CustomersTable = (props) => {
  ...
  const columns = [
    ...
    { title: "Area Name", field: "areaName" , width: "8%",},
    { title: "Area Code", field: "areaCode" , width: "8%",},
  ...
  const showSweetAlert = () => {
    ...
    swal({
      ...
      text: `Are you sure to delete ${customer.areaName}?`,
      icon: "warning",
      buttons: {
        cancel : 'No',
      ...
      if (response) {
        axios.delete(`http://127.0.0.1:80/api/v1/areas/${customer._id}`).then(()=> {
          swal({text: `You have successfully deleted ${customer.areaName}`,
